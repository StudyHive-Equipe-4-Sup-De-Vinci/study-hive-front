      ...
      <div className="content">
        ...
        <div className="tabs">
          <div className="tab-list">
            <button className="tab active" data-tab="populaires">
              Populaires
            </button>
            <button className="tab" data-tab="recents">
              Récents
            </button>
            <button className="tab" data-tab="meilleurs">
              Meilleurs
            </button>
          </div>
          ...
          <div className="tab-content active" id="populaires">
            ...
            <div className="course-card">
              ...
              <div className="course-content">
                ...
                <div className="course-description">
                  <p>
                    Ce cours explore les concepts mathématiques essentiels pour
